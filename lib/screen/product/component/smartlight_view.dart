                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: CarouselSlider.builder(
                                    ...
                                    itemCount: listSmartBulb.length,
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    listProductSmartLight[_current]
                                            [_currentProduct]
                                        .nama!,
                            ...
                            Container(
                              ...
                              child: Image.asset(
                                listProductSmartLight[_current][_currentProduct]
                                    .grafikImage!,
                                fit:
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: CarouselSlider.builder(
                            ...
                            itemCount: listProductSmartLight[_current].length,
                            itemBuilder: (context, index, realIndex) {
                              var listProduct =
                                  listProductSmartLight[_current][index];
                              return Container(
                                height: width < 800 ? 400 : 450,
                                padding: EdgeInsets.zero,
                                child: Column(
